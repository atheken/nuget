    ...
    public class MisplacedScriptFileRuleTest
    {
        ...
        public void ScriptsOutsideToolsFolder()
        {
            ...
            PackageIssueTestHelper.AssertPackageIssue(
                ...
                "The script file '" + PathFixUtility.FixPath("content\\install.ps1") +
        ...
        public void UnrecognizedScriptsInsideToolsFolder()
        {
            ...
            PackageIssueTestHelper.AssertPackageIssue(
                ...
                "The script file '" + PathFixUtility.FixPath("tools\\hello.ps1") + "' is not recognized by NuGet and hence will not be executed during installation of this package.",
                "Rename it to install.ps1, uninstall.ps1 or init.ps1 and place it directly under 'tools'.");

            PackageIssueTestHelper.AssertPackageIssue(
                issues[1],
                "Unrecognized PowerScript file.",
                "The script file '" + PathFixUtility.FixPath("tools\\abc.ps1") +
